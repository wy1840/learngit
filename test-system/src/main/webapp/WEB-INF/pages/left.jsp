    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        <li class="active treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>考试管理</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a id="load-question-id"><i class="fa fa-circle-o"></i>试题管理</a></li>
            <li><a id="load-student-id"><i class="fa fa-circle-o"></i>学生管理</a></li>
        ...
        <!-- <li class="treeview">
          ...
          <ul class="treeview-menu"> -->
           <!--  <li><a href="#"><i class="fa fa-circle-o"></i>组织管理</a></li>
            ...
            <!-- <li><a id="load-user-id"><i class="fa fa-circle-o"></i>参加考试</a></li>
          </ul>
        </li> -->
      </ul>
    </section>
...
$('#load-question-id').click(function(){
	var url="questions/listUI.do?t="+Math.random(1000);
	$(".content").load(url);
})
$('#load-student-id').click(function(){
	var url="student/listUI.do?t="+Math.random(1000);
	$(".content").load(url);
})
...
$('#load-user-id').click(function(){
	var url = "stuQuestions/listUI.do?t="+Math.random(1000);
	$(".content").load(url);
})
</script>